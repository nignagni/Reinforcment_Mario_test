...
test = np.array_split(game_over[10:],[30,2],axis = 1)
...
annealing_steps = 1#How many steps of training to reduce startE to endE.
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        while j < max_epLength: #If the agent takes longer than 200 moves to reach either of the blocks, end the trial.
            ...
            comparenew = np.array_split(compare[10:],[30,2],axis = 1)
            #opencv recognize 
